"""
WriteTool for SmolD - File writing tool
...
"""
    ...
    inputs = {
        "file_path": {"type": "string", "description": "The path to the file to write (relative paths are resolved relative to current working directory)"},
    ...
    def forward(self, file_path: str, content: str) -> str:
        ...
        Args:
            file_path: The path to the file to write (relative paths resolved to current working directory)
